...
import DateTimeFormat from "../components/DateTime"
...
const DateTimeAttr=DateFormat.DateAttr;
...
const FieldCorAttr = {
  ...
  datetimeformat: {
    ...
    getReallyField: item => {
      return <DatePicker showTime={true} format={item.formatValue} placeholder={item.tipValue} style={{ width: "100%" }} />;
    }
  }
    ,
  dateformatsection: {
